...
export class HttpService {
    ...
    requestFlickr(method, params, successFn, errorFn) {
        let paramsList = [];
        ...
        let key = APP_CONFIG.flickrApi;
        let url = `https://api.flickr.com/services/rest/?method=${method}&api_key=${key}&${params}&format=json&nojsoncallback=1`;
